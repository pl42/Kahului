...
public class Kahului {
  ...
  /**
   * Returns the current state of Kahului. This relates to whether the bot is waiting for a buy back
   * or not
   *
  ...
  public void predictAndTrade() {
    ...
    // Gather data calculate, and update Kahului's target price and buy back
