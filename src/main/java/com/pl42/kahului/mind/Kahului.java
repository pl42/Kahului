...
public class Kahului {
  ...
  /**
   * Instantiates a new instance of Kahului's mind. It requires an API Key and the API Key secret to
  ...
  public Kahului(String binanceAPIKey, String binanceAPISecret) {
  ...
  private void reportDevMode() {
    logger.error("Kahului is currently in development mode! Not performing trades or tweets");
  }
}
