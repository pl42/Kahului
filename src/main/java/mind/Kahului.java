...
public class Kahului {
	...
	private final static Logger logger = Logger.getLogger(Kahului.class);
	...
	/**
	 * Instantiates a new instance of Kahului's mind. It requires an API Key
	 ...
	 * Kahului decides to sell and buy back.
	 *
